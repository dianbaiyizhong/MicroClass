...
public class SubmitReplyCommentServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String s_RepliedCommentID = request.getParameter("CommentID");
		int i_CommentID = Integer.parseInt(s_RepliedCommentID);
		...
		comments.setCommentID(i_CommentID);

		if (commentsImpl.AddReplyComment(comments)) {
