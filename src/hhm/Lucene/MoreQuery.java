...
public class MoreQuery {
	...
	public void RangeQuery() {
		Term lowerTerm = new Term("size", NumberTools.longToString(260000));
		Term upperTerm = new Term("size", NumberTools.longToString(560000));
	...
	public void PhraseQuery() {
		...
		phraseQuery.add(new Term("content", "办公室"));
		phraseQuery.add(new Term("content", "狼藉"));

		// 这个东西的效果是可以让查找的词语之间最多不超过这么多个分词，他就可以查询出来
	...
	public void QueryString() {
		...
		// String queryString = "-content:\"绅士 饭店\"~2 AND -size:[000000000000dw TO 000000000000rs]";
		// String queryString = "-content:\"绅士 饭店\"~2 OR -size:[000000000000dw TO 000000000000rs]";
		String queryString = "-content:\"疼爱 父亲\"~2 NOT -size:[000000000000dw TO 000000000000rs]";
